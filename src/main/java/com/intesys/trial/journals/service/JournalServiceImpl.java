...
import com.intesys.trial.journals.controller.PublisherController;
...
import com.intesys.trial.journals.repository.CategoryRepository;
import com.intesys.trial.journals.repository.JournalRepository;
import com.intesys.trial.journals.repository.UserRepository;
...
public class JournalServiceImpl implements JournalService {
	...
	@Override
	public List<Journal> getNew() {
		return journalRepository.findByPublishDateBetween(new Date(new Date().getTime()-1000*60*60*24), new Date());
	}
}
