...
ALTER TABLE item RENAME category;

ALTER TABLE journal ADD category_id BIGINT UNSIGNED NOT NULL;
ALTER TABLE journal ADD CONSTRAINT category_id FOREIGN KEY (category_id) REFERENCES category(id);
